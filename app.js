...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIps = __webpack_require__(164);

	var _getIps2 = _interopRequireDefault(_getIps);

	var _getOrgs = __webpack_require__(163);
	...
	(0, _getIps2['default'])(null, null, function (iparray) {
	...
	(0, _getOrgs2['default'])(null, function (orgs) {
	  console.log('orgs: ' + orgs);
	  _reactDom2['default'].render(_react2['default'].createElement(_dropdown2['default'], { organizations: orgs }), document.getElementById('dropdown'));
	});

	_reactDom2['default'].render(_react2['default'].createElement(_scroll2['default'], null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactScrollbar = __webpack_require__(159);
	...
	var Scroll = function (_React$Component) {
	    ...
	    function Scroll(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Scroll).call(this, props));
	    }
	    ...
	    _createClass(Scroll, [{
	        ...
	        value: function () {
	            function render() {
	                var assemblies = [];
	                assemblies.push(_react2['default'].createElement(
	                    'div',
	                    { className: 'assembly', id: 'primer' },
	                    'primer'
	                ));
	                assemblies.push(_react2['default'].createElement(
	                    'div',
	                    { className: 'assembly', id: 'onesie' },
	                    'onesie'
	                ));
	                assemblies.push(_react2['default'].createElement(
	                    'div',
	                    { className: 'assembly', id: 'landline' },
	                    'landline'
	                ));
	                assemblies.push(_react2['default'].createElement(
	                    'div',
	                    { className: 'assembly', id: 'jenkins' },
	                    'jenkins'
	                ));
	                assemblies.push(_react2['default'].createElement(
	                    'div',
	                    { className: 'assembly', id: 'slacker' },
	                    'slacker-acorn'
	                ));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDropDown = __webpack_require__(161);
	...
	var DropDownComponent = function (_React$Component) {
	  ...
	  function DropDownComponent(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DropDownComponent).call(this, props));

	    _this.state = { value: _this.props.organizations[0] };
	    return _this;
	  }
	...
	DropDownComponent.propTypes = {
	  organizations: _react2['default'].PropTypes.array.isRequired
	};
...
/***/ function(module, exports) {
	...
	exports['default'] = function (error, callback) {
	  callback(['GRT', 'Mr. Lee\'s Greater Hong Kong', 'Nova Sicilia', 'The Raft', 'Reverend Wayne\'s Pearly Gates']);
	};
...
/***/ function(module, exports) {
	...
	exports['default'] = function (error, params, callback) {
	  ...
	  callback(['213.324.34', '214.34.34', '234.324.23', '134.32.234']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".assembly {\n  width: 800px;\n\theight: 300px;\n\tfont-size: 18px;\n\tbox-sizing: border-box;\n\tpadding-left: 10px;\n\tpadding-top: 10px;\n}\n.assembly:nth-of-type(odd) {\n\tbackground: #C0C0C0;\n}\n\n#dropdown {\n  padding-bottom: 30px;\n}\n\nselect {\n  font-size: 18px;\n  width: 200px;\n}\n\np {\n  font-size: 18px;\n}\n", ""]);
